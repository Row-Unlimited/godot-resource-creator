...
To overwrite the default scene, enter a valid resource path to your scene into the plugin_config.tres.  
You can either write it directly into the resource or save it via the settings menu. (For the change to apply you have to press the reload button in the plugin or reload the project)
